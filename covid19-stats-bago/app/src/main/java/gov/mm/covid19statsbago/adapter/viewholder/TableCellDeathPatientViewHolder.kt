 ...
 */
class TableCellDeathPatientViewHolder(private val view: View) : AbstractViewHolder(view) {
    ...
    private fun requestLayout(text:String) {
        ...
        if(text?.toInt()>0) {
            ...
            view.tv_date.setTextColor (view.context.getColorValue(R.color.colorWhite))
            view.tv_date.setBackgroundColor(Color.RED)
